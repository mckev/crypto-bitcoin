...
class TestB56(unittest.TestCase):
    ...
    def test_convert_btc_wif_into_btc_private_key(self):
        btc_private_key = BTC.convert_btc_wif_into_private_key('5HueCGU8rMjxEXxiPuD5BDku4MkFqeZyd4dZ1jvhTVqvbTLvyTJ')
    ...
    def test_btc_key_pair(self):
        ...
        btc_private_key = BTC.convert_btc_wif_into_private_key(btc_private_key_in_wif)
