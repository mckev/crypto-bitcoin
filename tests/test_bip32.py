...
class TestBip32:
    ...
    def test_derive_from_path_01(self):
        seed_bytes = b'\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f'

        path = "m"
        last_depth, private_fingerprint, last_index, chain_code, private_int = Bip32.derive_from_path(seed_bytes, path)
        xprv = Bip32.serialize_xprv(last_depth, private_fingerprint, last_index, chain_code, private_int)
        xpub = Bip32.serialize_xpub(last_depth, private_fingerprint, last_index, chain_code, private_int)
    ...
    def test_derive_from_path_02(self):
        seed_bytes = b''
    ...
    def test_derive_from_path_03(self):
        seed_bytes = b''
    ...
    def test_derive_from_path_04(self):
        seed_bytes = b'\x3d\xdd\x56\x02\x28\x58\x99\xa9\x46\x11\x45\x06\x15\x7c\x79\x97\xe5\x44\x45\x28\xf3\x00\x3f\x61\x34\x71\x21\x47\xdb\x19\xb6\x78'

        path = "m"
        last_depth, private_fingerprint, last_index, chain_code, private_int = Bip32.derive_from_path(seed_bytes, path)
        xprv = Bip32.serialize_xprv(last_depth, private_fingerprint, last_index, chain_code, private_int)
        xpub = Bip32.serialize_xpub(last_depth, private_fingerprint, last_index, chain_code, private_int)
        assert xprv == 'xprv9s21ZrQH143K48vGoLGRPxgo2JNkJ3J3fqkirQC2zVdk5Dgd5w14S7fRDyHH4dWNHUgkvsvNDCkvAwcSHNAQwhwgNMgZhLtQC63zxwhQmRv'
        assert xpub == 'xpub661MyMwAqRbcGczjuMoRm6dXaLDEhW1u34gKenbeYqAix21mdUKJyuyu5F1rzYGVxyL6tmgBUAEPrEz92mBXjByMRiJdba9wpnN37RLLAXa'

        path = "m/0'"
        last_depth, private_fingerprint, last_index, chain_code, private_int = Bip32.derive_from_path(seed_bytes, path)
        xprv = Bip32.serialize_xprv(last_depth, private_fingerprint, last_index, chain_code, private_int)
        xpub = Bip32.serialize_xpub(last_depth, private_fingerprint, last_index, chain_code, private_int)
        assert xprv == 'xprv9vB7xEWwNp9kh1wQRfCCQMnZUEG21LpbR9NPCNN1dwhiZkjjeGRnaALmPXCX7SgjFTiCTT6bXes17boXtjq3xLpcDjzEuGLQBM5ohqkao9G'
        assert xpub == 'xpub69AUMk3qDBi3uW1sXgjCmVjJ2G6WQoYSnNHyzkmdCHEhSZ4tBok37xfFEqHd2AddP56Tqp4o56AePAgCjYdvpW2PU2jbUPFKsav5ut6Ch1m'

        path = "m/0'/1'"
        last_depth, private_fingerprint, last_index, chain_code, private_int = Bip32.derive_from_path(seed_bytes, path)
        xprv = Bip32.serialize_xprv(last_depth, private_fingerprint, last_index, chain_code, private_int)
        xpub = Bip32.serialize_xpub(last_depth, private_fingerprint, last_index, chain_code, private_int)
        assert xprv == 'xprv9xJocDuwtYCMNAo3Zw76WENQeAS6WGXQ55RCy7tDJ8oALr4FWkuVoHJeHVAcAqiZLE7Je3vZJHxspZdFHfnBEjHqU5hG1Jaj32dVoS6XLT1'
        assert xpub == 'xpub6BJA1jSqiukeaesWfxe6sNK9CCGaujFFSJLomWHprUL9DePQ4JDkM5d88n49sMGJxrhpjazuXYWdMf17C9T5XnxkopaeS7jGk1GyyVziaMt'
